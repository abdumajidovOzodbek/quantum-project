    ...
    return (
        <footer className="bg-gray-800 p-4 fixed bottom-0 w-full z-10">
            <div className="container mx-auto flex justify-around items-center">
                <NavLink to="/profile" className="text-white flex flex-col items-center" activeClassName="text-blue-400">
                    <FontAwesomeIcon icon={faUserCircle} size="lg" />
                    <span className="mt-1 text-xs">My Profile</span>
                </NavLink>
                <NavLink to="/upload" className="text-white flex flex-col items-center" activeClassName="text-blue-400">
